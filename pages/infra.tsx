...
const SUBGRAPHS = [
  ...
  'https://graph.bean.money/beanstalk-dev',
  'https://graph.bean.money/beanstalk-testing',
  'https://graph.bean.money/bean',
  'https://graph.bean.money/bean-dev',
  'https://graph.bean.money/bean-testing',
  'https://graph.bean.money/basin',
  'https://graph.bean.money/basin-dev',
  'https://graph.bean.money/basin-testing',
  'https://graph.bean.money/beanstalk_eth',
  'https://graph.bean.money/bean_eth',
  'https://graph.bean.money/basin_eth'
];
          ...
          <tbody>
            {SUBGRAPHS.map((url: string, idx: number) =>
                <React.Fragment key={url}>
                  {idx % 3 == 0 && <hr style={{ width: '625%', margin: '10px auto', display: 'block' }} />}
